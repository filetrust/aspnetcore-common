...
{
    [TestFixture]
    public class WhenReadingWithEncryptionEnabled : FileStoreEncryptionTestBase
    {
        ...
        public async Task Setup()
        {
            ...
            var encryptedStreamContent = Encoding.UTF8.GetBytes("ThisFileIsEncrypted---thensomedatawoopwoop");
        ...
        [Test]
        public void Decryption_Is_Called()
        {
            Encryption.Verify(s => s.DecryptAsync(It.IsAny<byte[]>(), It.IsAny<byte[]>(), It.IsAny<byte[]>(),
