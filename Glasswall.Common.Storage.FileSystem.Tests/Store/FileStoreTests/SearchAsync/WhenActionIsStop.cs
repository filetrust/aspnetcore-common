...
namespace Glasswall.Common.Storage.FileSystem.Tests.Store.FileStoreTests.SearchAsync
{
    ...
    public class WhenActionIsStop : FileStoreTestBase
    {
        ...
        public async Task Setup()
        {
            ...
            await foreach (var path in ClassInTest.SearchAsync("", new StopAllActionDecider(),
                new CancellationToken(false))) _paths.Add(path);
        }
